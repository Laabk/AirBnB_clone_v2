...
class TestPlace(unittest.TestCase):
    ...
    def test_checking_for_docstring_Place(self):
        """
        testing to check for docstrings
        """
        self.assertIsNotNone(Place.__doc__)

    def test_attributes_Place(self):
        """
        testing to check amenity have attributes
        """
    ...
    def test_is_subclass_Place(self):
        """
        testing to check Place is subclass of Basemodel
        """
        self.assertTrue(issubclass(self.place.__class__, BaseModel), True)

    def test_attribute_types_Place(self):
        """
        testing the attribute type for Place
        """
    ...
    def test_save_Place(self):
        """testing to ensure the save works"""
        self.place.save()
        self.assertNotEqual(self.place.created_at, self.place.updated_at)

    def test_to_dict_Place(self):
        """testing to ensure if dictionary works"""
