#!/usr/bin/python3
"""
testing the console to ensure it works
"""
import unittest
...
class TestConsole(unittest.TestCase):
    ...
    def tearDown(self):
        """
        Removing all temporary file created due to precees
        """
        try:
            os.remove("file.json")
        except IOError:
    ...
    def test_quit(self):
        """
        testing the quit command inpout
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_create_errors(self):
        """
        Testing the create command errors.
        """
        with patch("sys.stdout", new=StringIO()) as f:
    ...
    def test_create(self):
        """
        Testing the create command inpout
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_show(self):
        """Testing the show button command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """Testing the destroy command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_update(self):
        """
        Testing the update command inpout
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_all(self):
        """
        Testing the other way all command inpout
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_count(self):
        """
        Testing the count command inpout
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_show(self):
        """
        Testing other ways show command inpout
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """
        testing other ways to destroy command inpout
        """
        with patch('sys.stdout', new=StringIO()) as f:
